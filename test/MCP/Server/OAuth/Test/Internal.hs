...
Description : Conformance test interface contract
...
This module provides the interface for the polymorphic OAuth conformance test suite.
...
oauthConformanceSpec ::
    TestConfig m ->
    Spec
oauthConformanceSpec _config =
    describe "OAuth Conformance Suite (Stub)" $ do
        it "is not yet implemented" $
            pendingWith "Full HTTP-level conformance tests will be implemented in future beads"
